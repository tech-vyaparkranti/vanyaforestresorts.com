...
@section('title', 'Our Guest Review')
@section('content')

    <x-content-div heading="Manage Guest Review">
        <x-card-element header="Add Testimonial">
            <x-form-element method="POST" enctype="multipart/form-data" id="submitForm" action="javascript:">
                ...
                <x-input-with-label-element id="heading_middle" label="Guest Review Link "
                ...
                <x-select-with-label id="slide_status" name="slide_status" label="Select Guest Review Status" required="true">
                    <option value="live">Live</option>
                    <option value="disabled">Disabled</option>
                </x-select-with-label>
                <x-input-with-label-element id="slide_sorting" label="Guest Review Sorting" type="numeric"
        ...
        <x-card-element header="Guest Review Data">
            <x-data-table>
