...
<div class="information-content">
    <ul class="m-auto list-unstyled custom-container">
        ...
        <li><a href="">Wedding Enquiry</a></li>
    </ul>
</div>
<div id="about">
            ...
            <div class="row mb-4 info-container">
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                    <div class="contact-form-area mb-2">
                        ...
                        <form enctype="multipart/form-data" method="POST" id="weddingenquiryForm" action="javascript:">
                            @csrf
...
<div class="col-md-6 mb-3">
    <div class="form-group">
        <label for="first_name">Occassion</label>
...
<div class="col-md-6 mb-3">
    <div class="form-group">
        <label for="capacity">Budget</label>
        <input type="number" class="form-control" id="capacity" name="capacity" required>
    </div>
</div>
<div class="col-md-6 mb-3">
    <div class="form-group">
<label for="message">No. of Guests</label>
                <select id="message" name="message" class="form-control" required>
...
@section('script')
    <script>
        $("#weddingenquiryForm").on("submit", function() {
