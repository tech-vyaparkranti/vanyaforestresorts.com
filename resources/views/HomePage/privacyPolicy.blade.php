        ...
        <div class="default-content pt-5 pb-3">
            <div class="custom-container">
                ...
                <div class="midd-content">
                    <p class="text-justify">We respect and are committed towards protecting your privacy. Publishing, selling or renting any personal data or information to any third party, without your consent, is against our ethics. 
                        </p>
                    <p class="text-justify">The privacy practices of this statement apply to our services available under the domain and subdomains of the Site. By visiting this Site you agree to be bound by the terms and conditions of this privacy policy. If you do not agree, please do not use or access our site. 
                        </p>
                    <p class="text-justify">This privacy policy does not apply to sites maintained by other companies or organizations to which we link and we are not responsible for any personal information you submit to third parties via our website. Please ensure that you read the privacy policy of such other companies or organizations before submitting your details. 
                        </p>
                    ...
                    <ul>
                        <li>
                            ...
                            <p class="text-justify">Cookies help you make your online experience more efficient and relevant to your interests. For instance, they are used to remember your preferences on sites you visit often, to remember your user ID and the contents of your shopping baskets, and to help you navigate between pages efficiently.</p>
                        </li>
                        <li>
                            <h5>What is a Cookie?</h5>
                            <p class="text-justify">A cookie is a small file, or files on your computer, phone, or other device with a browser to save snippets of text for reference by the website you are visiting. All cookies have expiration dates in them that determine how long they stay in your browser:</p>
                        </li>
                        <li>
                            {{-- <h5>Why are cookies important?</h5> --}}
                            <p class="text-justify"><b>Session cookies</b> - these are temporary cookies that expire (and are automatically erased) whenever you close your browser.</p>
                        </li>
                        <li>
                            {{-- <h5>Why are cookies important?</h5> --}}
                            <p class="text-justify"><b>Persistent cookies</b> - these usually have an expiration date and so stay in your browser until they expire, or until you manually delete them. For example we use persistent cookies to better understand usage patterns so that we can improve the site for our customers.</p>
                        </li>
                        <p class="text-justify">Cookies are grouped into the following categories:</p>
                        <li><b>Essential </b>- these are cookies that are required for the regular operation of our websites.</li>
                        <li><b>Functional</b> - these remember your preferences, and are intended to make your experience on our websites better for you.</li>
                    ...
                    <p class="text-justify">To ensure compliance with our policies, we restrict the use of third-party cookies to trusted partners.
                    ...
                    <p class="text-justify">To delete cookies from your browser, please note the following simple steps. The following steps are indicative for Google chrome and might vary of the different browsers that you may use. Please refer Settings on your browser for further details.</p>
                    <p class="text-justify">To ensure compliance with our policies, we restrict the use of third-party cookies to trusted partners.
