...
class BlogRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            "short_content"=>"bail|nullable",
            "meta_keyword"=>"bail|nullable",
            "meta_title"=>"bail|nullable",
            "meta_description"=>"bail|nullable",
            "facebook_link"=>"bail|nullable|string",
            "twitter_link"=>"bail|nullable|string",
            "instagram_link"=>"bail|nullable|string",
            "youtube_link"=>"bail|nullable|string",
