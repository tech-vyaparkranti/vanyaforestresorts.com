...
class RecreationalActivitiesRequest extends FormRequest
{
    /**
    ...
    {
        return [
            "id"=>"bail|required_if:action,update,enable,disable|nullable|exists:recreational_activities,id",
            ...
            "image2"=>"bail|file|image|required_if:action,insert",
            "image3"=>"bail|file|image|required_if:action,insert",
