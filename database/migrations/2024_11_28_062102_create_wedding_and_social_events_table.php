...
class CreateWeddingAndSocialEventsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('wedding_and_social_events', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('wedding_and_social_events');
    }
}
