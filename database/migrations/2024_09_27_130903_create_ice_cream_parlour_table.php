...
class CreateIceCreamParlourTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ice_cream_parlour', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('slide_sorting')->nullable(false)->default("1")->index("ice_cream_parlour_index");
    ...
    {
        Schema::dropIfExists('ice_cream_parlour');
    }
}
